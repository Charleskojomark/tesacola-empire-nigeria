    ...
    <div className="space-y-4">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-2 border-b border-[#30363d]">
        ...
        <button
          ...
          className="px-3 py-1.5 bg-[#21262d] hover:bg-[#30363d] border border-[#30363d] text-[#d6be67] text-xs font-medium rounded transition-colors flex items-center gap-1.5 self-start"
        >
          ...
          return (
            <div
              ...
              className={`p-4 rounded-lg border transition-all ${
                slot.isMain
                  ? "bg-[#1c2128] border-[#d6be67]/60 shadow-[0_0_15px_rgba(214,190,103,0.05)]"
                  : "bg-[#161b22] border-[#30363d] hover:border-neutral-600"
              }`}
            >
              {/* Header with Slot Title, Type Switch, and Main Badge */}
              <div className="flex items-center justify-between gap-2 mb-3">
                <div className="flex items-center gap-2 min-w-0">
                  <input
                    ...
                    className="bg-transparent text-xs font-semibold text-white border-b border-dashed border-neutral-600 focus:border-[#d6be67] focus:outline-none py-0.5 max-w-[200px]"
                  />
                  {slot.isMain && (
                    <span className="px-2 py-0.5 bg-[#d6be67]/20 border border-[#d6be67]/40 text-[#d6be67] text-[10px] font-semibold uppercase tracking-wider rounded">
                      Main Thumbnail
                    </span>
                  )}
                </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="flex-1 px-3 py-2 bg-[#21262d] hover:bg-[#30363d] border border-[#30363d] text-white text-xs font-medium rounded flex items-center justify-center gap-2 transition-colors"
                  >
                    <Upload className="w-3.5 h-3.5 text-[#d6be67]" />
                    <span>Upload {slot.mediaType === "VIDEO" ? "Video File (.mp4)" : "Image File"}</span>
                  </button>

                  {!slot.isMain && hasContent && (
                    <button
                      type="button"
                      onClick={() => handleSetMain(slot.id)}
                      className="px-2.5 py-2 bg-[#0d1117] hover:bg-[#21262d] border border-[#30363d] text-neutral-400 hover:text-[#d6be67] text-xs font-medium rounded flex items-center gap-1 transition-colors"
                      title="Set as Main Card Thumbnail"
                    >
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder={
                      slot.mediaType === "VIDEO"
                        ? "Or paste video URL (https://...mp4, Vimeo, CDN)"
                        : "Or paste image URL (https://...jpg, Unsplash, CDN)"
                    }
